...
**5,504 characters, about 1,528 tokens** — paid in every conversation, called or not.
...
| find_licences, no filter | 4,872 | 1,353 | 20 of 180 rows |
| find_licences, one territory | 691 | 192 | 3 row(s), complete |
| find_licences, active only | 4,790 | 1,331 | 20 of 63 rows |
| search_titles, 20 results | 2,478 | 688 | 20 row(s) |
| licence_detail, one licence | 618 | 172 | 1 row(s) |
<!-- endregion: call_cost -->

The unfiltered call costs **0.9×** the entire tool
